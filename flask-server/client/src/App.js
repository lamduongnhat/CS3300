    ...
    <div className="home-container">
      <header className="hero-section">
        ...
        <p className="subtitle">
          A simple platform for students and instructors to share, organize, and
          explore learning videos.
        </p>
        <p className="group-members">Group Members: Hilton, Lam, Khai, Poe</p>
      </header>
      ...
      <section className="about-section">
        ...
        <p>
          ...
          ask questions, comment on lessons, and rate how helpful each lesson
          is.
        </p>
      </section>
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            <h3>User Accounts</h3>
            <p>
              Students and instructors can sign up, log in, and manage profiles.
            </p>
          </div>
          ...
          <div className="feature-card">
            <h3>Lesson Videos</h3>
            <p>
              Store learning videos with title, description, upload date, and
              URL.
            </p>
          </div>
